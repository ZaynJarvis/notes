...
export const SHELL_STRINGS = {
  en: {
    ...
    indexEyebrow: '2026',
    indexTitle: 'Notes in Public.',
    indexLede: 'Personal engineering notes on agents, systems, product decisions, and the work behind them.',
    indexFocus: 'Agents / systems / product',
    indexCadence: 'Working notes',
    countLabel: (n) => `${n} essays`,
    visitCount: (n) => `${n} visits`,
    filterAll: 'All',
    filterMore: 'More',
    filterLess: 'Less',
    ...
    emptyBody: 'The old imported blog posts have been cleared. New notes will appear here as they are published.',
  },
  zh: {
    siteName: 'Zayn Notes',
    siteSub: '技术笔记',
    indexEyebrow: '2026',
    indexTitle: '公开笔记',
    indexLede: '关于 Agent、系统、产品判断和实际工作的个人工程笔记。',
    indexFocus: 'Agent / 系统 / 产品',
    indexCadence: '工作笔记',
    countLabel: (n) => `${n} 篇文章`,
    visitCount: (n) => `${n} 次访问`,
    filterAll: '全部',
    ...
    tags: '标签',
    emptyTitle: '暂无公开笔记',
    emptyBody: '旧的导入博客内容已清空。新的笔记发布后会出现在这里。',
  },
};
